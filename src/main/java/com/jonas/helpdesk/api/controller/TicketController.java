package com.jonas.helpdesk.api.controller;
...
import com.jonas.helpdesk.api.dto.Summary;
import com.jonas.helpdesk.api.response.Response;
import com.jonas.helpdesk.api.security.entity.ChangeStatus;
import com.jonas.helpdesk.api.security.entity.Ticket;
import com.jonas.helpdesk.api.security.entity.User;
import com.jonas.helpdesk.api.security.enums.ProfileEnum;
import com.jonas.helpdesk.api.security.enums.StatusEnum;
import com.jonas.helpdesk.api.security.jwt.JwtTokenUtil;
import com.jonas.helpdesk.api.service.TicketService;
import com.jonas.helpdesk.api.service.UserService;
...
public class TicketController {
	...
	@ApiOperation(value="Find All Tickets {page}/{count}")
	...
	@ApiOperation(value="Find Tickets By Params: {page}/{count}/{number}/{title}/{status}/{priority}/{assigned}")
	...
	@ApiOperation(value="Change Ticket Status By Params: /{id}/{status}")
	...
	@ApiOperation(value="Ticket Sumary")
